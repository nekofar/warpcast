...
- _(client)_ Remove unnecessary semicolons in type definitions
- _(openapi)_ Standardize array and enum formatting

### ⚙️ Miscellaneous Tasks

- _(ci)_ Update workflow formatting and dependencies
- _(docs)_ Update changelog formatting and remove extra line
