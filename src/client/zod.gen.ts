...
export const zDirectCastConversation = z.object({
	...
	removedFids: z.array(z.int()),
	participants: z.array(zUser),
	lastReadTime: z.coerce.bigint(),
	selfLastReadTime: z.coerce.bigint(),
	pinnedMessages: z.array(zDirectCastMessage),
	hasPinnedMessages: z.boolean(),
	isGroup: z.boolean(),
	isCollectionTokenGated: z.boolean(),
	activeParticipantsCount: z.int().gte(0),
	messageTTLDays: z.int().gte(0),
